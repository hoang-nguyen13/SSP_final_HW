...
material_list = {'Si', 'Ge', 'Sn', 'GaP', 'GaAs', 'AlSb', 'InP', 'GaSb', 'InAs', 'InSb', 'ZnS', 'ZnSe', 'ZnTe', 'CdTe'};
...
ff(2,:) = [ -0.6951 -0.23 0.01 0.06 0.00 0.00 0.00]; % Ge
ff(3,:) = [ -0.5015 -0.20 0.00 0.04 0.00 0.00 0.00]; % Sn
ff(4,:) = [ -0.6775 -0.22 0.03 0.07 0.12 0.07 0.02]; % GaP
ff(5,:) = [ -0.6527 -0.23 0.01 0.06 0.07 0.05 0.01]; % GaAs
ff(6,:) = [ -0.5107 -0.21 0.02 0.06 0.06 0.04 0.02]; % AlSb
ff(7,:) = [ -0.5627 -0.23 0.01 0.06 0.07 0.05 0.01]; % InP
ff(8,:) = [ -0.5112 -0.22 0.00 0.05 0.06 0.05 0.01]; % GaSb
ff(9,:) = [ -0.5251 -0.22 0.00 0.05 0.08 0.05 0.03]; % InAs
ff(10,:)= [ -0.4460 -0.20 0.00 0.04 0.06 0.05 0.01]; % InSb
ff(11,:)= [ -0.4677 -0.22 0.03 0.07 0.24 0.14 0.04]; % ZnS
ff(12,:)= [ -0.4496 -0.23 0.01 0.06 0.18 0.12 0.03]; % ZnSe
ff(13,:)= [ -0.3925 -0.22 0.00 0.05 0.13 0.10 0.01]; % ZnTe
ff(14,:)= [ -0.3117 -0.20 0.00 0.04 0.15 0.09 0.04]; % CdTe
